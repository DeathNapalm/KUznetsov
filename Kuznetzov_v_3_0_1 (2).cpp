// Kuznetzov.cpp: определ€ет точку входа дл€ консольного приложени€.
//
				...
				for (int q = 0; q < num; q++) {
					...
					if (showcalc) {
						...
						if (newfunc) {
							...
							cout << "внутренн€€ функци€ 1:" << endl;
							for (int f = 0; f < n*n; f++) cout << arg1[f] << " ";

							cout << endl << "внутренн€€ функци€ 2:" << endl;
							for (int f = 0; f < n*n; f++) cout << arg2[f] << " ";

							cout << endl << "подставл€ем во внешнюю функцию 3:" << endl;
...
int main()
{
	...
	cout << "введите разр€дность логики (2-...)" << endl;
	int n = 2;
	cin >> n;
